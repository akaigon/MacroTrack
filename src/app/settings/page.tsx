...
export default function SettingsPage() {
  ...
  return (
    <div>
      ...
      {/* Macro targets (direct editing + weekly cycling) */}
      <div className="mt-8">
        <h2 className="mb-1 text-base font-semibold">Macro targets</h2>
        <p className="mb-3 text-xs text-muted">
          Set your own numbers here. Note: saving your profile above, or
          accepting a weekly check-in, recalculates the default targets — so
          fine-tune these afterwards if you want fully custom macros.
        </p>
        <TargetsSettings />
      </div>
